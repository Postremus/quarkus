 ...
 */
public class DevModeContext implements CustomSerDeriable {
    ...
    public static class ModuleInfo implements CustomSerDeriable {
        ...
        public void serialize(OutputStream out) {
            CustomSerDerUtil.writeArtifactKey(appArtifactKey, out);
            CustomSerDerUtil.writeString(name, out);
            CustomSerDerUtil.writeString(projectDirectory, out);
            if (main == null) {
            ...
            CustomSerDerUtil.writeString(preBuildOutputDir, out);
            CustomSerDerUtil.writePathCollection(sourceParents, out);
            CustomSerDerUtil.writeString(targetDir, out);
        }

        public static ModuleInfo deserialize(ByteBuffer buffer) {
            ModuleInfo.Builder m = new ModuleInfo.Builder();
            m.appArtifactKey = CustomSerDerUtil.readArtifactKey(buffer);
            m.name = CustomSerDerUtil.readString(buffer);
            m.projectDirectory = CustomSerDerUtil.readString(buffer);
            var main = CompilationUnit.deserialize(buffer);
            var test = CompilationUnit.deserialize(buffer);
            if (main != null) {
            ...
            m.preBuildOutputDir = CustomSerDerUtil.readString(buffer);
            m.sourceParents = CustomSerDerUtil.readPathCollection(buffer);
            m.targetDir = CustomSerDerUtil.readString(buffer);
            return m.build();
        }
    ...
    public static class CompilationUnit implements CustomSerDeriable {
        ...
        public void serialize(OutputStream out) {
            ...
            CustomSerDerUtil.writePathCollection(sourcePaths, out);
            CustomSerDerUtil.writeString(classesPath, out);
            CustomSerDerUtil.writePathCollection(resourcePaths, out);
            CustomSerDerUtil.writeString(resourcesOutputPath, out);
        }

        public static CompilationUnit deserialize(ByteBuffer buffer) {
            boolean exists = CustomSerDerUtil.readBoolean(buffer);
            if (!exists) {
                return null;
            }
            PathCollection sourcePaths = CustomSerDerUtil.readPathCollection(buffer);
            String classesPath = CustomSerDerUtil.readString(buffer);
            PathCollection resourcePaths = CustomSerDerUtil.readPathCollection(buffer);
            String resourcesOutputPath = CustomSerDerUtil.readString(buffer);
    ...
    @Override
    public void serialize(OutputStream out) {
        applicationRoot.serialize(out);
        CustomSerDerUtil.writeCollection(additionalModules, out, ModuleInfo::serialize);
        CustomSerDerUtil.writeMap(systemProperties, out, CustomSerDerUtil::writeString, CustomSerDerUtil::writeString);
        CustomSerDerUtil.writeMap(buildSystemProperties, out, CustomSerDerUtil::writeString, CustomSerDerUtil::writeString);
        CustomSerDerUtil.writeString(sourceEncoding, out);
        CustomSerDerUtil.writeFile(cacheDir, out);
        CustomSerDerUtil.writeFile(projectDir, out);
        CustomSerDerUtil.writeBoolean(test, out);
        CustomSerDerUtil.writeBoolean(abortOnFailedStart, out);
        CustomSerDerUtil.writeFile(devModeRunnerJarFile, out);
        CustomSerDerUtil.writeBoolean(localProjectDiscovery, out);
        CustomSerDerUtil.writeCollection(args, out, CustomSerDerUtil::writeString);
        CustomSerDerUtil.writeCollection(compilerOptions, out, CustomSerDerUtil::writeString);
        CustomSerDerUtil.writeString(releaseJavaVersion, out);
        CustomSerDerUtil.writeString(sourceJavaVersion, out);
        CustomSerDerUtil.writeString(targetJvmVersion, out);
        CustomSerDerUtil.writeCollection(compilerPluginArtifacts, out, CustomSerDerUtil::writeString);
        CustomSerDerUtil.writeCollection(compilerPluginsOptions, out, CustomSerDerUtil::writeString);
        CustomSerDerUtil.writeString(alternateEntryPoint, out);
        CustomSerDerUtil.writeString(mode.name(), out);
        CustomSerDerUtil.writeString(baseName, out);
        CustomSerDerUtil.writeCollection(localArtifacts, out, CustomSerDerUtil::writeArtifactKey);
    }

    public static DevModeContext deserialize(ByteBuffer buffer) {
        DevModeContext context = new DevModeContext();
        context.applicationRoot = ModuleInfo.deserialize(buffer);
        context.additionalModules.addAll(CustomSerDerUtil.readCollection(buffer, ModuleInfo::deserialize, ArrayList::new));
        context.systemProperties
                .putAll(CustomSerDerUtil.readMap(buffer, CustomSerDerUtil::readString, CustomSerDerUtil::readString));
        context.buildSystemProperties
                .putAll(CustomSerDerUtil.readMap(buffer, CustomSerDerUtil::readString, CustomSerDerUtil::readString));
        context.sourceEncoding = CustomSerDerUtil.readString(buffer);
        context.cacheDir = CustomSerDerUtil.readFile(buffer);
        context.projectDir = CustomSerDerUtil.readFile(buffer);
        context.test = CustomSerDerUtil.readBoolean(buffer);
        context.abortOnFailedStart = CustomSerDerUtil.readBoolean(buffer);
        context.devModeRunnerJarFile = CustomSerDerUtil.readFile(buffer);
        context.localProjectDiscovery = CustomSerDerUtil.readBoolean(buffer);
        context.args = CustomSerDerUtil.readCollection(buffer, CustomSerDerUtil::readString, ArrayList::new);
        context.compilerOptions = CustomSerDerUtil.readCollection(buffer, CustomSerDerUtil::readString, ArrayList::new);
        context.releaseJavaVersion = CustomSerDerUtil.readString(buffer);
        context.sourceJavaVersion = CustomSerDerUtil.readString(buffer);
        context.targetJvmVersion = CustomSerDerUtil.readString(buffer);
        context.compilerPluginArtifacts = CustomSerDerUtil.readCollection(buffer, CustomSerDerUtil::readString, ArrayList::new);
        context.compilerPluginsOptions = CustomSerDerUtil.readCollection(buffer, CustomSerDerUtil::readString, ArrayList::new);
        context.alternateEntryPoint = CustomSerDerUtil.readString(buffer);
        context.mode = QuarkusBootstrap.Mode.valueOf(CustomSerDerUtil.readString(buffer));
        context.baseName = CustomSerDerUtil.readString(buffer);
        context.localArtifacts.addAll(CustomSerDerUtil.readCollection(buffer, CustomSerDerUtil::readArtifactKey, HashSet::new));
